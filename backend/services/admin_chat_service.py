...
TABLES = {
    ...
    'spare_parts': (SparePart, 'spare_part_id submitted_by equipment_id part_number part_name manufacturer description specifications compatibility availability_status created_at updated_at'),
